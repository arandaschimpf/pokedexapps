  ...
  return (
    <main class="container mx-auto flex flex-col">
      ...
      <div class="flex justify-center gap-2">
        ...
        <button onClick={() => setPage(Math.min(pageCount(), page() + 1))} disabled={page() === pageCount()} class="p-2 bg-red-600 text-white rounded-lg mt-2 font-bold uppercase duration-200 disabled:opacity-50 hover:bg-red-700">Next</button>
      </div>
    </main>
  );
}

...
export default function App() {
  //para leer el primer elemento list()
  const [list, setList] = createSignal<Pokemon[]>([]); // setList se encarga de actualizar nuestro componente, su estado inicial: <Pokemon[]>([])
  ...
  const addPokemon = async (event: Event) => {    //no hace falta especificar el tipo de elemento

  ...
  async function addPokemon(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        form.reset();
        setError('Pokemon agregado correctamente');
  ...
  return (
    <main className="container mx-auto flex flex-col">
      ...
      <div className="flex justify-between gap-2 absolute top-0 right-0 mt-2 mr-2">
        <button onClick={() => { pageP('/login'); logout(); eliminarCookie(); }} className="p-2 bg-red-600 text-white rounded-lg font-bold uppercase duration-200 hover:bg-red-700">Salir</button>
      </div>
